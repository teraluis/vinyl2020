...
if(!class_exists('Skudmart_MegaMenu_Walker')){

    class Skudmart_MegaMenu_Walker extends Walker_Nav_Menu {
            ...
            if ($depth == 0) {
                ...
                if ($item->menu_type == "wide") {
                    ...
                    if(!empty($item->popup_background)){
                        ...
                        $popup_custom_styles .= LAHB_Helper::render_background_atts($popup_background, false);
                    }
        ...
        public static function fallback( $args ){
            return str_replace( array("page_item", "menu-item_has_children","<ul class='children'>"), array("page_item menu-item", "menu-item-has-children","<ul class='sub-menu'>"), wp_list_pages('echo=0&title_li=') );
        }
    }
}