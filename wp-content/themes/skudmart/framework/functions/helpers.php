...
if ( ! function_exists( 'skudmart_get_option' ) ) {

    function skudmart_get_option( $key = '', $default = '' ) {
        $theme_options = get_option('skudmart_options', array());
        ...
        return apply_filters( 'skudmart/filter/get_option', $value, $key, $default, $theme_options);
    }

}

if ( ! function_exists( 'skudmart_get_post_meta' ) ) {
    function skudmart_get_post_meta( $object_id, $sub_key = '', $meta_key = '', $single = true ) {
        ...
        if (empty($meta_key)) {
            $meta_key = '_skudmart_post_options';
        }
...
if ( ! function_exists( 'skudmart_get_term_meta' ) ) {
    function skudmart_get_term_meta( $object_id, $sub_key = '', $meta_key = '', $single = true ) {

        if (!is_numeric($object_id)) {
            return false;
        }
        if (empty($meta_key)) {
            $meta_key = '_skudmart_term_options';
        }
...
if ( ! function_exists( 'skudmart_get_theme_option_by_context') ) {

    function skudmart_get_theme_option_by_context( $key = '', $default = '' ){
        if( $key == '' ){
            return $default;
        }

        $value = $value_default = skudmart_get_option( $key, $default );

        if( is_home() ) {
            $_value = skudmart_get_option("{$key}_blog");
            if(!empty($_value)){
                if(is_array($_value)){
                    if(skudmart_array_filter_recursive($_value)){
                        $value = $_value;
                    }
                }
                else{
        ...
        if( is_home() || is_front_page() ) {
            ...
            if( ($key == 'main_space' || $key == 'main_full_width') && ( is_home() && !is_front_page() ) ) {
                $_value = skudmart_get_option("{$key}_archive_post");
                if(!empty($_value)){
                    if(is_array($_value)){
                        if(skudmart_array_filter_recursive($_value)){
                            $value = $_value;
            ...
            if ( $current_object_id = get_queried_object_id() ) {
                $_value = skudmart_get_post_meta( $current_object_id, $key );
                if(!empty($_value)){
                    if(is_array($_value)){
                        if(skudmart_array_filter_recursive($_value)){
                            $value = $_value;
        ...
        elseif ( is_singular() ) {
            ...
            if(is_singular('post') && $key == 'layout'){
                $_value = skudmart_get_option('layout_blog');
                if(!empty($_value) && $_value !== 'inherit'){
                    $value = $_value;
                }
            }

            $_value = skudmart_get_option("{$key}_single_{$post_type}", $value_default );
            ...
            $_value = skudmart_get_post_meta( get_queried_object_id(), $key );
        ...
        elseif( is_archive() ) {
            ...
            if( function_exists('is_shop') && is_shop() ){
                $_value = skudmart_get_option("{$key}_archive_product", $value_default );
                if(!empty($_value)){
                    if(is_array($_value)){
                        if(skudmart_array_filter_recursive($_value)){
                            $value = $_value;
                ...
                if( $shop_page_id = wc_get_page_id('shop') ){
                    $_value = skudmart_get_post_meta( $shop_page_id, $key );
                    if(!empty($_value)){
                        if(is_array($_value)){
                            if(skudmart_array_filter_recursive($_value)){
                                $value = $_value;
            ...
            elseif( function_exists('is_product_taxonomy') && is_product_taxonomy() ){
                ...
                $_value = skudmart_get_term_meta( get_queried_object_id(), $key);
                if(!empty($_value)){
                    if(is_array($_value)){
                        if(skudmart_array_filter_recursive($_value)){
                            $value = $_value;
            ...
            elseif( is_post_type_archive('la_portfolio') ) {
                $_value = skudmart_get_option("{$key}_archive_portfolio", $value_default);
                if(!empty($_value)){
                    if(is_array($_value)){
                        if(skudmart_array_filter_recursive($_value)){
                            $value = $_value;
            ...
            elseif( is_tax() && is_tax(get_object_taxonomies( 'la_portfolio' ))){
                ...
                if($key == 'layout'){
                    ...
                    $_value = skudmart_get_option("{$key}_archive_post", $value_default);
                    if(!empty($_value)){
                        if(is_array($_value)){
                            if(skudmart_array_filter_recursive($_value)){
                                $value = $_value;
        ...
        return apply_filters('skudmart/filter/get_theme_option_by_context', $value, $key );
...
if ( ! function_exists( 'skudmart_get_schema_markup' ) ) {

    function skudmart_get_schema_markup( $location ) {

        // Return if disable
        if ( ! skudmart_get_option( 'schema_markup', true ) ) {
            return null;
        }
        ...
        return ' ' . apply_filters( 'skudmart_schema_markup', $schema );

    }

}

if ( ! function_exists( 'skudmart_schema_markup' ) ) {

    function skudmart_schema_markup( $location ) {

        echo skudmart_get_schema_markup( $location );

    }

}

if ( ! function_exists('skudmart_social_sharing') ) {
    function skudmart_social_sharing( $post_link = '', $post_title = '', $image = '', $post_excerpt = '', $echo = true){
        ...
        if(skudmart_string_to_bool(skudmart_get_option('sharing_facebook'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="facebook" title="%2$s"><i class="lastudioicon-b-facebook"></i></a>',
                ...
                esc_attr_x('Share this post on Facebook', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_twitter'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="twitter" title="%2$s"><i class="lastudioicon-b-twitter"></i></a>',
                ...
                esc_attr_x('Share this post on Twitter', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_reddit'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="reddit" title="%2$s"><i class="lastudioicon-b-reddit"></i></a>',
                ...
                esc_attr_x('Share this post on Reddit', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_linkedin'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="linkedin" title="%2$s"><i class="lastudioicon-b-linkedin"></i></a>',
                ...
                esc_attr_x('Share this post on Linked In', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_tumblr'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="tumblr" title="%2$s"><i class="lastudioicon-b-tumblr"></i></a>',
                ...
                esc_attr_x('Share this post on Tumblr', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_pinterest'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="pinterest" title="%2$s"><i class="lastudioicon-b-pinterest"></i></a>',
                ...
                esc_attr_x('Share this post on Pinterest', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_line'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="network-line" title="%2$s"><i class="lastudioicon-b-line"></i></a>',
                ...
                esc_attr_x('LINE it!', 'front-view', 'skudmart')
            );

        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_vk'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="vk" title="%2$s"><i class="lastudioicon-b-vkontakte"></i></a>',
                ...
                esc_attr_x('Share this post on VK', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_whatapps'))){
            printf('<a href="%1$s" rel="nofollow" class="whatsapp" data-action="share/whatsapp/share" title="%2$s"><i class="lastudioicon-b-whatsapp"></i></a>',
                ...
                esc_attr_x('Share via Whatsapp', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_telegram'))){
            printf('<a href="%1$s" rel="nofollow" class="telegram" title="%2$s"><i class="lastudioicon-b-telegram"></i></a>',
                ...
                esc_attr_x('Share via Telegram', 'front-view', 'skudmart')
            );
        }
        if(skudmart_string_to_bool(skudmart_get_option('sharing_email'))){
            printf('<a target="_blank" href="%1$s" rel="nofollow" class="email" title="%2$s"><i class="lastudioicon-mail"></i></a>',
                ...
                esc_attr_x('Share this post via Email', 'front-view', 'skudmart')
            );
        }
        echo '</span>';
        if(!$echo){
...
if ( ! function_exists( 'skudmart_the_pagination' ) ) {

    function skudmart_the_pagination($args = array(), $query = null) {
        if(null === $query) {
        ...
        $loadmore_html .= '<div class="post__loadmore_ajax pagination_ajax_loadmore"><a href="javascript:;"><span>'.esc_html__('Load More', 'skudmart').'</span></a></div>';
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_blog_wrap_classes' ) ) {

    function skudmart_blog_wrap_classes( $classes = NULL ) {
        ...
        $classes = apply_filters( 'skudmart/filter/blog_wrap_classes', $classes );
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_has_breadcrumbs' ) ) {

    function skudmart_has_breadcrumbs() {

        // Return true by default
        $return = true;

        // Apply filters and return
        return apply_filters( 'skudmart/filter/display_breadcrumbs', $return );
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_excerpt' ) ) {

    function skudmart_excerpt( $length = 30 ) {
        global $post;
...
if( !function_exists('skudmart_render_variable') ) {
    function skudmart_render_variable( $variable ) {
        return $variable;
    }
}

if ( ! function_exists( 'skudmart_array_filter_recursive' ) ) {

    function skudmart_array_filter_recursive($array, $callback = null, $remove_empty_arrays = true) {
        if(!is_scalar($array)){
            foreach ($array as $key => & $value) { // mind the reference
                if (is_array($value)) {
                    $value = skudmart_array_filter_recursive($value, $callback, $remove_empty_arrays);
...
if ( ! function_exists( 'skudmart_transfer_text_to_format' ) ) {
    function skudmart_transfer_text_to_format ( $content, $autop = false ) {
        if ( $autop ) {
...
if ( ! function_exists( 'skudmart_get_site_layout' ) ) {

    function skudmart_get_site_layout(){

        $layout = skudmart_get_theme_option_by_context('layout', 'col-1c');

        if($layout != '' && !is_active_sidebar(apply_filters('skudmart/filter/sidebar_primary_name', 'sidebar'))){
            $layout =  'col-1c';
        }

        return apply_filters('skudmart/get_site_layout', $layout);
...
if ( ! function_exists( 'skudmart_get_header_layout' ) ) {

    function skudmart_get_header_layout(){

        if( 'default' == get_option('lastudio_header_layout', 'default') ) {
            return 'default';
        }
        return skudmart_get_theme_option_by_context('header_layout', 1);

    }

}

if ( ! function_exists( 'skudmart_get_page_header_layout' ) ) {

    function skudmart_get_page_header_layout(){

        if(is_404()){
            return 'hide';
        }
        return skudmart_get_theme_option_by_context('page_title_bar_layout', 'hide');

    }

}

if ( ! function_exists( 'skudmart_get_footer_layout' ) ) {

    function skudmart_get_footer_layout(){

        return skudmart_get_theme_option_by_context('footer_layout', '');

    }

}

if ( !function_exists('skudmart_header_classes' ) ) {

    function skudmart_header_classes(){
        ...
        $classes = apply_filters( 'skudmart_header_classes', $classes );
...
if ( !function_exists('skudmart_footer_classes' ) ) {

    function skudmart_footer_classes(){
        ...
        $footer_layout = skudmart_get_footer_layout();
        ...
        // Apply filters for child theming
        $classes = apply_filters( 'skudmart_footer_classes', $classes );
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_comment' ) ) {

    function skudmart_comment( $comment, $args, $depth ) {
        ...
        switch ( $comment->comment_type ) :
            ...
            case 'trackback' :
                ...
                <article id="comment-<?php comment_ID(); ?>" class="comment-container">
                    <p><?php esc_html_e( 'Pingback:', 'skudmart' ); ?> <span><span<?php skudmart_schema_markup( 'author_name' ); ?>><?php comment_author_link(); ?></span></span> <?php edit_comment_link( esc_html__( '(Edit)', 'skudmart' ), '<span class="edit-link">', '</span>' ); ?></p>
                </article>
            ...
            <li id="comment-<?php comment_ID(); ?>" class="comment-container">
                ...
                <article <?php comment_class( 'comment-body' ); ?>>
                    ...
                    <?php echo get_avatar( $comment, apply_filters( 'skudmart_comment_avatar_size', 150 ) ); ?>

                    <div class="comment-content-outer">

                        <div class="comment-author">
                            <h3 class="comment-link"><?php printf( esc_html__( '%s ', 'skudmart' ), sprintf( '%s', get_comment_author_link() ) ); ?></h3>
                        ...
                        <div class="comment-entry">
                            <?php if ( '0' == $comment->comment_approved ) : ?>
                                <p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'skudmart' ); ?></p>
                            <?php endif; ?>
                        ...
                        <span class="comment-meta commentmetadata">
                            ...
                            <?php edit_comment_link(__('edit', 'skudmart' )); ?>
                        </span>
                    </div>
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_modify_comment_form_fields' ) ) {

    function skudmart_modify_comment_form_fields( $fields ) {

        $commenter = wp_get_current_commenter();
        $req       = get_option( 'require_name_email' );

        $fields['author'] 	= '<div class="comment-form-author"><input type="text" name="author" id="author" value="'. esc_attr( $commenter['comment_author'] ) .'" placeholder="'. esc_attr__( 'Name (required)', 'skudmart' ) .'" size="22" tabindex="101"'. ( $req ? ' aria-required="true"' : '' ) .' class="input-name" /></div>';

        $fields['email'] 	= '<div class="comment-form-email"><input type="text" name="email" id="email" value="'. esc_attr( $commenter['comment_author_email'] ) .'" placeholder="'. esc_attr__( 'Email', 'skudmart' ) .'" size="22" tabindex="102"'. ( $req ? ' aria-required="true"' : '' ) .' class="input-email" /></div>';

        $fields['url'] 		= '<div class="comment-form-url"><input type="text" name="url" id="url" value="'. esc_attr( $commenter['comment_author_url'] ) .'" placeholder="'. esc_attr__( 'Website', 'skudmart' ) .'" size="22" tabindex="103" class="input-website" /></div>';

        return $fields;

    }

    add_filter( 'comment_form_default_fields', 'skudmart_modify_comment_form_fields' );
 ...
 * String to boolean
 */
if(!function_exists('skudmart_string_to_bool')){
    function skudmart_string_to_bool( $string ){
...
if(!function_exists('skudmart_get_list_image_sizes')){

    function skudmart_get_list_image_sizes() {
        ...
        return array_merge( array( 'full' => esc_html__( 'Full', 'skudmart' ), ), $result );
    }
}
/**
 * Get social HTML
...
if(!function_exists('skudmart_entry_meta_item_category_list')){
    function skudmart_entry_meta_item_category_list($before = '', $after = '', $separator = ', ', $parents = '', $post_id = false){
        add_filter('get_the_terms', 'skudmart_exclude_demo_term_in_category');
        $categories_list = get_the_category_list('{{_}}', $parents, $post_id );
        skudmart_deactive_filter('get_the_terms', 'skudmart_exclude_demo_term_in_category');
        if ( $categories_list ) {
            printf(
                '%3$s<span class="screen-reader-text">%1$s </span><span>%2$s</span>%4$s',
                esc_html_x('Posted in', 'front-view', 'skudmart'),
...
if(!function_exists('skudmart_exclude_demo_term_in_category')){
    function skudmart_exclude_demo_term_in_category( $term ){
        return apply_filters('skudmart/post_category_excluded', $term);
    }
}

if(!function_exists('skudmart_deactive_filter')){
    function skudmart_deactive_filter( $tag, $function_to_remove, $priority = 10) {
        return call_user_func('remove_filter', $tag, $function_to_remove, $priority );
    }
}

if(!function_exists('skudmart_render_responsive_main_space_options')){
    function skudmart_render_responsive_main_space_options( $default = array() ) {
        return wp_parse_args( $default, array(
            ...
            'tabs'  => array(
                ...
                array(
                    'title'  => esc_html_x('Laptop', 'admin-view', 'skudmart'),
                ...
                array(
                    'title'  => esc_html_x('Desktop', 'admin-view', 'skudmart'),
                    'icon'   => 'fa fa-desktop',
                    'fields' => array(
                        array(
                            'id'    => 'desktop',
...
if(!function_exists('skudmart_render_responsive_font_size_options')){
    function skudmart_render_responsive_font_size_options( $default = array() ) {
        return wp_parse_args( $default,  array(
            'type'              => 'tabbed',
            'class'             => 'lasf-responsive-tabs',
            'tabs'              => array(
...
if(!function_exists('skudmart_render_responsive_column_options')){
    function skudmart_render_responsive_column_options( $default = array() ){
        return wp_parse_args( $default, array(
...
if(!function_exists('skudmart_render_responsive_item_space_options')){
    function skudmart_render_responsive_item_space_options( $default = array(), $css_output = array() ) {
...
if(!function_exists('skudmart_options_section_page_title_bar_auto_detect')){
    function skudmart_options_section_page_title_bar_auto_detect( $key = 'default', $inherit = false ) {

        $base_options = array();

        $subtitle_for_default   = esc_html_x('For page header bar', 'admin-view', 'skudmart');
        ...
        $key_allows = array(
            ...
            'woocommerce' => array(
                'key' => 'woo_',
                'subtitle' => '['. esc_html_x('WooCommerce', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of WooCommerce Settings ( Shop page / Product Category / Product Tags and Search page )', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            ),
            'single_product' => array(
                'key' => 'single_product_',
                'subtitle' => '['. esc_html_x('Single Product', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of Single Product', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            ),
            'single_post' => array(
                'key' => 'single_post_',
                'subtitle' => '['. esc_html_x('Single Post', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of Post pages', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            ),
            'blog_post' => array(
                'key' => 'blog_post_',
                'subtitle' => '['. esc_html_x('Blog Post', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of Blog/Tag/Category pages', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            ),
            'archive_portfolio' => array(
                'key' => 'archive_portfolio_',
                'subtitle' => '['. esc_html_x('Archive Portfolio', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of Archive Portfolio', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            ),
            'single_portfolio' => array(
                'key' => 'single_portfolio_',
                'subtitle' => '['. esc_html_x('Single Portfolio', 'admin-view', 'skudmart') .'] ' . $subtitle_for_default,
                'override_subtitle' => esc_html_x('Turn on to override all setting page header bar of Single Portfolio', 'admin-view', 'skudmart'),
                'override_info' => esc_html_x('This option will not work with these pages were overwritten', 'admin-view', 'skudmart'),
            )
        );
        ...
        $layout_options = array( 'hide' => esc_html_x('Do not display', 'admin-view', 'skudmart') ) + Skudmart_Options::get_config_page_title_bar_opts(false);

        if($inherit){
            $layout_options = array(
                    'inherit' => esc_html_x('Inherit', 'admin-view', 'skudmart'),
                    'hide' => esc_html_x('Do not display', 'admin-view', 'skudmart'),
                ) + Skudmart_Options::get_config_page_title_bar_opts(false);
            $subtitle = '';
        ...
        $base_options = array(
            array(
                ...
                'type'          => 'select',
                'title'         => esc_html_x('Select Layout', 'admin-view', 'skudmart'),
            ...
            array(
                ...
                'type'                  => 'border',
                'title'                 => esc_html_x('Page Header Border', 'admin-view', 'skudmart'),
                'subtitle'              => $subtitle,
            ...
            array(
                ...
                'type'                  => 'background',
                'title'                 => esc_html_x('Page Header Background', 'admin-view', 'skudmart'),
            ...
            skudmart_render_responsive_main_space_options(array(
                ...
                'title'                 => esc_html_x('Page Header Spacing', 'admin-view', 'skudmart'),
                'subtitle'              => $subtitle,
                'dependency'            => $dependency,
            )),
            ...
            array(
                ...
                'type'              => 'typography',
                'title'             => esc_html_x('Heading Fonts', 'admin-view', 'skudmart'),
                'text_align'        => false,
                'color'             => false,
                'extra_styles'      => true,
                'responsive'        => true,
            ...
            array(
                ...
                'type'              => 'typography',
                'title'             => esc_html_x('Breadcrumb Fonts', 'admin-view', 'skudmart'),
                'text_align'        => false,
                'color'             => false,
                'extra_styles'      => true,
                'responsive'        => true,
            ...
            array(
                ...
                'default'       => Skudmart_Options::get_color_default('heading_color'),
                'type'          => 'color',
                'title'         => esc_html_x('Heading Color', 'admin-view', 'skudmart'),
                'subtitle'      => $subtitle,
                'dependency'    => $dependency
            ),
            ...
            array(
                ...
                'default'       => Skudmart_Options::get_color_default('text_color'),
                'type'          => 'color',
                'title'         => esc_html_x('Text Color', 'admin-view', 'skudmart'),
                'subtitle'      => $subtitle,
                'dependency'    => $dependency
            ),
            ...
            array(
                ...
                'default'       => Skudmart_Options::get_color_default('text_color'),
                'type'          => 'color',
                'title'         => esc_html_x('Link Color', 'admin-view', 'skudmart'),
                'subtitle'      => $subtitle,
                'dependency'    => $dependency
            ),
            ...
            array(
                ...
                'default'       => Skudmart_Options::get_color_default('text_color'),
                'type'          => 'color',
                'title'         => esc_html_x('Link Hover Color', 'admin-view', 'skudmart'),
                'subtitle'      => $subtitle,
                'dependency'    => $dependency
            ),
        );
        ...
        if($key != 'default'){
            array_unshift($base_options, array(
                ...
                'type'          => 'button_set',
                'default'       => 'off',
                'title'         => esc_html_x('Enable Override', 'admin-view', 'skudmart'),
        ...
        if($key == 'default' && !$inherit){
            array_unshift($base_options, array(
                ...
                'type'          => 'select',
                'default'       => 'h1',
                'title'         => esc_html_x('Heading Tag', 'admin-view', 'skudmart'),
                'options'       => array(
                    'h1' => 'H1',
                    'h2' => 'H2',
                    'h3' => 'H3',
...
if(!function_exists('skudmart_get_responsive_columns')){
    function skudmart_get_responsive_columns( $key = '', $default = array()){
        $value = skudmart_get_option($key, $default);
...
if(!function_exists('skudmart_get_responsive_column_classes')){
    function skudmart_get_responsive_column_classes( $key = '', $default = array()){
        $value = skudmart_get_option($key, $default);
        $columns = wp_parse_args( $value, array(
            'mobile' => '',
            'mobile_landscape' => '',
...
if(!function_exists('skudmart_minify_css')){
    function skudmart_minify_css( $css = '' ){
        // Return if no CSS
        if ( ! $css ) return;
...
if(!function_exists('skudmart_render_border_style_from_setting')){
    function skudmart_render_border_style_from_setting( $value, $element = '' ){
        $output    = '';
...
if(!function_exists('skudmart_render_background_style_from_setting')){
    function skudmart_render_background_style_from_setting( $value, $element = '' ){
        $output = '';
...
if(!function_exists('skudmart_render_typography_style_from_setting')){
    function skudmart_render_typography_style_from_setting( $value,  $element = '', $screen = 'mobile' ){
        ...
        if( isset($value['responsive']) && skudmart_string_to_bool($value['responsive']) ){
            foreach( $properties as $property ) {
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'skudmart_post_id' ) ) {

    function skudmart_post_id() {
        ...
        // Apply filters
        $id = apply_filters( 'skudmart/filter/current_post_id', $id );
 ...
 * @since 1.0.0
 */
if(!function_exists('skudmart_title')){
    function skudmart_title(){
        // Default title is null
        $title = NULL;

        // Get post ID
        $post_id = skudmart_post_id();
        ...
        if ( is_front_page() && ! is_singular( 'page' ) ) {
            ...
            if ( get_bloginfo( 'description' ) ) {
                ...
                return esc_html__( 'Recent Posts', 'skudmart' );
            }
        ...
        elseif ( is_search() ) {
            global $wp_query;
            $title = '<span id="search-results-count">'. $wp_query->found_posts .'</span> '. esc_html__( 'Search Results Found', 'skudmart' );
        }
        ...
        elseif ( is_archive() ) {
            ...
            // Daily archive title
            elseif ( is_day() ) {
                $title = sprintf( esc_html__( 'Daily Archives: %s', 'skudmart' ), get_the_date() );
            }

            // Monthly archive title
            elseif ( is_month() ) {
                $title = sprintf( esc_html__( 'Monthly Archives: %s', 'skudmart' ), get_the_date( esc_html_x( 'F Y', 'Page title monthly archives date format', 'skudmart' ) ) );
            }

            // Yearly archive title
            elseif ( is_year() ) {
                $title = sprintf( esc_html__( 'Yearly Archives: %s', 'skudmart' ), get_the_date( esc_html_x( 'Y', 'Page title yearly archives date format', 'skudmart' ) ) );
            }
        ...
        elseif ( is_404() ) {
            ...
            $title = esc_html__( '404: Page Not Found', 'skudmart' );
        ...
        elseif ( $post_id ) {
            ...
            elseif ( is_singular( 'post' ) ) {
                ...
                if ( 'post-title' == skudmart_get_option( 'blog_post_page_title', 'blog' ) ) {
                    $title = get_the_title();
                } else {
                    $title = esc_html__( 'Blog', 'skudmart' );
                }
        ...
        return apply_filters( 'skudmart/filter/current_title', $title );
    }
}
...
if(!function_exists('skudmart_single_post_thumbnail')){
    function skudmart_single_post_thumbnail( $thumbnail_size = 'full' ) {
        if ( post_password_required() || is_attachment() ) {
            return;
        }
        $flag_format_content = false;

        $image_schema_markup = skudmart_get_schema_markup('image');

        switch(get_post_format()){
            case 'link':
                $link = skudmart_get_post_meta( get_the_ID(), 'format_link' );
                if(!empty($link)){
                    printf(
                ...
                break;
            case 'quote':
                $quote_content = skudmart_get_post_meta(get_the_ID(), 'format_quote_content');
                $quote_author = skudmart_get_post_meta(get_the_ID(), 'format_quote_author');
                $quote_background = skudmart_get_post_meta(get_the_ID(), 'format_quote_background');
                $quote_color = skudmart_get_post_meta(get_the_ID(), 'format_quote_color');
            ...
            case 'gallery':
                $ids = skudmart_get_post_meta(get_the_ID(), 'format_gallery');
                $ids = explode(',', $ids);
            ...
            case 'audio':
            case 'video':
                $embed_source = skudmart_get_post_meta(get_the_ID(), 'format_embed');
                $embed_aspect_ration = skudmart_get_post_meta(get_the_ID(), 'format_embed_aspect_ration');
        ...
        if(!$flag_format_content && has_post_thumbnail()){ ?>
            <div class="post-thumbnail">
                <a<?php
                if( 'video' == get_post_format() && ( $popup_video_link = skudmart_get_post_meta(get_the_ID(), 'format_video_url') ) && !empty($popup_video_link) ){
...
if (!function_exists('skudmart_wpml_object_id')) {
    function skudmart_wpml_object_id( $element_id, $element_type = 'post', $return_original_if_missing = false, $ulanguage_code = null ) {
...
if(!function_exists('skudmart_is_blog')){
    function skudmart_is_blog(){
        return (is_home() || is_tag() || is_category() || is_date() || is_year() || is_month() || is_author()) ? true : false;
    }
}

if(!function_exists('skudmart_get_wishlist_url')){
    function skudmart_get_wishlist_url(){
        $wishlist_page_id = skudmart_get_option('wishlist_page', 0);
        return (!empty($wishlist_page_id) ? get_the_permalink($wishlist_page_id) : esc_url(home_url('/')));
    }
}

if(!function_exists('skudmart_get_compare_url')){
    function skudmart_get_compare_url(){
        $compare_page_id = skudmart_get_option('compare_page', 0);
        return (!empty($compare_page_id) ? get_the_permalink($compare_page_id) : esc_url(home_url('/')));
    }
}

if(!function_exists('skudmart_render_access_component')){
    function skudmart_render_access_component( $type, $component = array(), $parent_name = '', $css_class = '' ){
        $exist_flag     = false;
        ...
        if(!empty($component['text'])){
            $current_user_name = __('Guest', 'skudmart');
        ...
        if(!empty($component['link'])){
            ...
            $component['link'] = apply_filters('skudmart/filter/component/link', $component['link'], $type);
        }
        ...
        switch($type){
            ...
            case 'text':
                ...
                if(!empty($component['text'])){
                    ...
                    $target_html .= apply_filters('skudmart/filter/component/text', $component['text']);
                    $target_html .= '</span>';
                    $target_html .= '</a>';
                }
                else{
            ...
            case 'cart':
                ...
                if(!empty($component['text'])){
                    $icon_html .= '<span class="component-target-text">'. apply_filters('skudmart/filter/component/text', $component['text']) .'</span>';
            ...
            case 'wishlist':
                ...
                $target_url = isset($component['link']) ? $component['link'] : '#';
                if($target_url == '#'){
                    $target_url = skudmart_get_wishlist_url();
                }
                if(class_exists('Skudmart_WooCommerce_Wishlist')){
                    $total_count = Skudmart_WooCommerce_Wishlist::get_count();
                }
            ...
            case 'compare':
                ...
                $target_url = isset($component['link']) ? $component['link'] : '#';
                if($target_url == '#'){
                    $target_url = skudmart_get_compare_url();
                }
                if(class_exists('Skudmart_WooCommerce_Compare')){
                    $total_count = Skudmart_WooCommerce_Compare::get_count();
                }
