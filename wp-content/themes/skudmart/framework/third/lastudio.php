...
if(!function_exists('skudmart_add_icon_to_fw_icon')){
    function skudmart_add_icon_to_fw_icon( $icons ) {
        $la_icon_lists = [
        ...
        $icons = array(
            array(
                'title' => esc_html__('LA-Studio Icons', 'skudmart'),
                'icons' => $la_icon_lists
            )
        );
        return $icons;
    }
    add_filter('lasf_field_icon_add_icons', 'skudmart_add_icon_to_fw_icon');
}

if(!function_exists('skudmart_render_socials_for_header_builder')){
    function skudmart_render_socials_for_header_builder(){
        $social_links = skudmart_get_option('social_links');
    ...
    add_action('lastudio/header-builder/render-social', 'skudmart_render_socials_for_header_builder');
}