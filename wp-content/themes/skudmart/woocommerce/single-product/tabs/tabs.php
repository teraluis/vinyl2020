	...
	<div class="wc-tabs-outer clearfix">
		<div class="woocommerce-tabs wc-tabs-wrapper">
			...
			<?php foreach ( $tabs as $key => $tab ) : ?>
				<div class="<?php if(isset($tab['el_class'])){ echo esc_attr($tab['el_class']); } ?> clearfix woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel wc-tab<?php if( $key == 'description' ) { echo ' entry-content'; } ?>" id="tab-<?php echo esc_attr( $key ); ?>">
