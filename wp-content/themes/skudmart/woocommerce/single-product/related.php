...
if ( $related_products ) : ?>
    ...
    $product_cols   = skudmart_get_responsive_columns('related_products_columns');
	...
	$title = skudmart_get_option('related_product_title');
	$sub_title = skudmart_get_option('related_product_subtitle');
				...
				<div class="col-xs-12">
					<h2 class="block_heading--title"><span><?php
                           if(!empty($title)){
                               ...
                               echo _x( 'Related Products', 'front-view', 'skudmart' );
                           }
                    ?></span></h2>
