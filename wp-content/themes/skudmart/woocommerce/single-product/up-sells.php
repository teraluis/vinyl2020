...
if ( $upsells ) : ?>
    ...
    $product_cols = skudmart_get_responsive_columns('upsell_products_columns');
    ...
    $title = skudmart_get_option('upsell_product_title');
    $sub_title = skudmart_get_option('upsell_product_subtitle');
            ...
            <div class="row block_heading vc_row" data-vc-full-width="true" data-vc-stretch-content="false">
                <div class="col-xs-12">
                    ...
                    if(!empty($title)){
                        ...
                        echo _x( 'You may also like&hellip;', 'front-view', 'skudmart' );
                    }
                    ?></span></h2>
