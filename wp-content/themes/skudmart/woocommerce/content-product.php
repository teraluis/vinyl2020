	...
	<div class="product_item--inner">
		<div class="product_item--thumbnail">
			<div class="product_item--thumbnail-holder">
				 ...
				 * @hooked Skudmart_WooCommerce::add_second_thumbnail_to_loop - 15
				 * 
				 */
			...
			<div class="product_item_thumbnail_action product_item--action">
				<?php
				/**
				 * skudmart/action/shop_loop_item_action hook.
				 */
				do_action('skudmart/action/shop_loop_item_action_top');
				?>
			</div>
            <?php
                do_action('skudmart/action/add_count_up_timer_in_product_listing');
            ?>
		</div>
		<div class="product_item--info">
			<div class="product_item--info-inner">
				 ...
				 * @hooked Skudmart_WooCommerce::render_attribute_in_list - 11
				 * @hooked Skudmart_WooCommerce::shop_loop_item_excerpt - 15
                 * @hooked woocommerce_template_loop_rating - 17
				 */
			...
			<div class="product_item--info-action product_item--action">
				 ...
				 *
				 */
				do_action('skudmart/action/shop_loop_item_action');
				?>
			</div>
		</div>
	<?php
