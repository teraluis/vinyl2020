...
$product_design = skudmart_get_option('woocommerce_product_page_design', 1);
...
if( skudmart_string_to_bool(skudmart_get_option('move_woo_tabs_to_bottom', 'no')) ){
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( $class, get_the_ID() ); ?>>
	...
	<div class="row s_product_content_top la-single-product-page">
		...
		<div class="<?php echo esc_attr($cssclass_right) ?>">
            <?php
            do_action( 'skudmart/action/before_woocommerce_single_product_summary' );
            ?>
            ...
            <?php
            do_action( 'skudmart/action/after_woocommerce_single_product_summary' );
            ?>
		</div><!-- .product-summary -->
	</div>
    ...
    do_action( 'skudmart/action/before_wc_tabs' );
    ...
    do_action( 'skudmart/action/after_wc_tabs' );
    ?>
