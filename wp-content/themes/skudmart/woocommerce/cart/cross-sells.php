...
<?php
    ...
    $product_cols = skudmart_get_responsive_columns('crosssell_products_columns');
	...
	$title = skudmart_get_option('crosssell_product_title');
	$sub_title = skudmart_get_option('crosssell_product_subtitle');
			...
			<div class="col-xs-12">
                <h2 class="block_heading--title"><span><?php
                        if(!empty($title)){
                            ...
                            echo _x( 'You may be interested in&hellip;', 'front-view', 'skudmart' );
                        }
                        ?></span></h2>
