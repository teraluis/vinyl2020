...
$enable_related = skudmart_get_option('blog_related_posts', 'off');
$related_style  = skudmart_get_option('blog_related_design', 1);
$max_related    = skudmart_get_option('blog_related_max_post', 1);
$related_by     = skudmart_get_option('blog_related_by', 'random');
...
if(!skudmart_string_to_bool($enable_related)){
    return;
}

$related_columns = skudmart_get_responsive_columns('blog_related_post_columns');
...
$slide_config = array(
    ...
    'arrows'   => true,
    'prevArrow'=> '<i class="lastudio-arrow prev-arrow lastudioicon-left-arrow"></i>',
    'nextArrow'=> '<i class="lastudio-arrow next-arrow lastudioicon-right-arrow"></i>',
    'rtl' => is_rtl()
);
...
if($related_query->have_posts()){
    ...
    <div class="section-related-posts related-posts-design-<?php echo esc_attr($related_style); ?><?php if($move_related_to_bottom){ echo ' related-post-after-main'; } ?>">
        ...
        <h3 class="related-posts-heading theme-heading"><?php esc_html_e('Related News', 'skudmart'); ?></h3>
                            ...
                            <div class="lastudio-posts__inner-box">
                                ...
                                if($blog_excerpt_length > 0){
                                    echo sprintf(
                                        ...
                                        skudmart_excerpt($blog_excerpt_length),
                                        skudmart_get_schema_markup('entry_content')
                                    );
                                }
