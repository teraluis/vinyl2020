...
$logo = skudmart_get_option('logo');
$default_logo = Skudmart_Theme_Class::$template_dir_url . '/assets/images/logo.png';
?>
                    ...
                    <div class="lahb-content-wrap lahb-area__auto">
                        <div class="lahb-col lahb-col__left">
                            <a href="<?php echo esc_url(home_url('/')); ?>" class="lahb-element lahb-logo">
                                ...
                                if(wp_attachment_is_image($logo)){
                            ...
                            <div class="lahb-responsive-menu-wrap lahb-responsive-menu-1546041916358" data-uniqid="1546041916358">
                                ...
                                <ul class="responav menu">
                                    ...
                                    $menu_output = wp_nav_menu( array(
                                        ...
                                        'items_wrap'    => '%3$s',
                                        'echo'          => false,
                                        'fallback_cb'   => array( 'Skudmart_MegaMenu_Walker', 'fallback' ),
                                        'walker'        => new Skudmart_MegaMenu_Walker
                                    ));
                                    echo skudmart_render_variable($menu_output);
                                    ?>
                                </ul>
                            </div>
                            <nav class="lahb-element lahb-nav-wrap nav__wrap_1546041916358" data-uniqid="1546041916358"><ul class="menu"><?php echo skudmart_render_variable($menu_output); ?></ul></nav>
                        </div>
                    </div>
                </div>
            </div>
