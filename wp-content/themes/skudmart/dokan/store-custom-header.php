...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'skudmart' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'skudmart' );
                ...
                <div id="wcvendor_profile_act_desc">
                    ...
                    <div id="wcvendor_profile_menu">
                        <form id="wcvendor_search_shops" action="<?php echo esc_url( dokan_get_store_url( $store_user->get_id() ) ); ?>" method="get" class="wcvendor-search-inside search-form">
                            <input class="search-field" autocomplete="off" type="search" name="s" placeholder="<?php esc_attr_e('Search in this shop', 'skudmart') ?>" value=""/>
