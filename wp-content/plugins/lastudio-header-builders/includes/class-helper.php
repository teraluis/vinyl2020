    ...
    class LAHB_Helper {
        ...
        public static function add_element( $id, $func_name, $dynamic_string = array() ) {
            ...
            if(!empty($dynamic_string)){
                self::$dynamic_strings[ $id ] = $dynamic_string;
            }
        }
        ...
        public static function get_dynamic_styles($preset_name = '') {
            ...
            $dynamic_styles = isset($_SESSION[$session_key]) ? $_SESSION[$session_key]: '';

            return apply_filters('lahb_get_dynamic_style', $dynamic_styles);
        }
        ...
        public static function translate_string($string = '', $unique_id = ''){
            $domain = 'LaStudio Header Builder';
            $context = 'Component';
            return apply_filters('wpml_translate_single_string', $string, $domain, $context);
        }
    }
