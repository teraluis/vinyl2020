 ...
 *
 */
if( ! class_exists( 'LASF_Widget' ) ) {
  class LASF_Widget extends WP_Widget {
    ...
    public function __construct( $key, $params ) {
      ...
      $this->unique = $key;
      $this->args   = apply_filters( "lasf_{$this->unique}_args", wp_parse_args( $params, $this->args ), $this );
      ...
      // Set filters
      $widget_ops  = apply_filters( "lasf_{$this->unique}_widget_ops", $widget_ops, $this );
      $control_ops = apply_filters( "lasf_{$this->unique}_control_ops", $control_ops, $this );
    ...
    public function form( $instance ) {
      ...
      if( ! empty( $this->args['fields'] ) ) {
        ...
        echo '<div class="lasf lasf-widgets lasf-fields">';
        ...
        foreach( $this->args['fields'] as $field ) {
          ...
          LASF::field( $field, $field_value, $field_unique );
    ...
    public function update( $new_instance, $old_instance ) {
      ...
      $new_instance = apply_filters( "lasf_{$this->unique}_save", $new_instance, $this->args, $this );

      do_action( "lasf_{$this->unique}_save_before", $new_instance, $this->args, $this );
