 ...
 *
 */
if( ! class_exists( 'LASF_Fields' ) ) {
  abstract class LASF_Fields extends LASF_Abstract {
    ...
    public function field_after() {
      ...
      $output  = ( ! empty( $this->field['desc'] ) ) ? '<p class="lasf-text-desc">'. $this->field['desc'] .'</p>' : '';
      $output .= ( ! empty( $this->field['after'] ) ) ? $this->field['after'] : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<span class="lasf-help"><span class="lasf-help-text">'. $this->field['help'] .'</span><span class="dashicons dashicons-editor-help"></span></span>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="lasf-text-error">'. $this->field['_error'] .'</p>' : '';
