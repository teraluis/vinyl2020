 ...
 *
 */
if( ! class_exists( 'LASF_Customize_Options' ) ) {
  class LASF_Customize_Options extends LASF_Abstract {
    ...
    public function add_customize_save( $wp_customize ) {
      do_action( "lasf_{$this->unique}_save_before", $this->get_options(), $this, $wp_customize );
      do_action( "lasf_{$this->unique}_saved", $this->get_options(), $this, $wp_customize );
      do_action( "lasf_{$this->unique}_save_after", $this->get_options(), $this, $wp_customize );
    }
    ...
    public function add_customize_options( $wp_customize ) {
      ...
      if( ! class_exists( 'WP_Customize_Panel_LASF' ) ) {
        LASF::include_plugin_file( 'functions/customize.php'  );
      }
      ...
      if( ! empty( $this->sections ) ) {
        ...
        foreach( $sections as $section ) {
          ...
          if( ! empty( $section['subs'] ) ) {
            ...
            $wp_customize->add_panel( new WP_Customize_Panel_LASF( $wp_customize, $panel_id, array(
              'title'       => $section['title'],
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      $wp_customize->add_section( new WP_Customize_Section_LASF( $wp_customize, $section_id, array(
      ...
      if( ! empty( $section_args['fields'] ) ) {
        ...
        foreach( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_LASF( $wp_customize, $setting_id,
