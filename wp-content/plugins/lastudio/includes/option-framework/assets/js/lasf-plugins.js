...
(function(root, factory) {
  ...
  //
  // LaStudio: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // LaStudio: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectLASF = FormSerializer.serializeObject;
    $.fn.serializeJSONLASF   = FormSerializer.serializeJSON;
  }
