( function( blocks, editor, element, components ) {
  ...
  if( !window.lasf_gutenberg_blocks ) { return; }

  window.lasf_gutenberg_blocks.forEach( function( block ) {
    ...
    registerBlockType('lasf-gutenberg-block/block-'+block.hash, {
        ...
        edit: function (props) {
          return (
            createElement('div', {className: 'lasf-shortcode-block'},

              createElement(Button, {
                'data-modal-id': block.modal_id,
                'data-gutenberg-id': block.hash,
                className: 'button is-button is-default is-large lasf-shortcode-button',
                onClick: function () {
                  window.lasf_gutenberg_props = props;
                },
              }, block.button_title ),
