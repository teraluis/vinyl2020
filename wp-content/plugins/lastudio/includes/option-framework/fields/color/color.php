 ...
 *
 */
if( ! class_exists( 'LASF_Field_color' ) ) {
  class LASF_Field_color extends LASF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. $this->field_name() .'" value="'. $this->value .'" class="lasf-color"'. $default_attr . $this->field_attributes() .'/>';
