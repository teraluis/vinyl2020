 ...
 *
 */
if( ! class_exists( 'LASF_Field_link_color' ) ) {
  class LASF_Field_link_color extends LASF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'lastudio' ),
        'hover'    => esc_html__( 'Hover', 'lastudio' ),
        'active'   => esc_html__( 'Active', 'lastudio' ),
        'visited'  => esc_html__( 'Visited', 'lastudio' ),
        'focus'    => esc_html__( 'Focus', 'lastudio' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="lasf--title">'. $color_prop_value .'</div>';
          echo '<input type="text" name="'. $this->field_name('['. $color_prop_key .']') .'" value="'. $value[$color_prop_key] .'" class="lasf-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
