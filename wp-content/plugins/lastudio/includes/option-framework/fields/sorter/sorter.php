 ...
 *
 */
if( ! class_exists( 'LASF_Field_sorter' ) ) {
  class LASF_Field_sorter extends LASF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'lastudio' ),
        'disabled_title' => esc_html__( 'Disabled', 'lastudio' ),
      ) );
      ...
      echo ( $args['disabled'] ) ? '<div class="lasf-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="lasf-sorter-title">'. $args['enabled_title'] .'</div>' : '';
      echo '<ul class="lasf-enabled">';
      ...
      if( $args['disabled'] ) {
        ...
        echo '<div class="lasf-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="lasf-sorter-title">'. $args['disabled_title'] .'</div>' : '';
        echo '<ul class="lasf-disabled">';
