...
<li class="price-list__item"><?php
    ...
    echo sprintf('<div class="price-list__item-img-wrap"><img src="%s" alt="" class="price-list__item-img"></div>', apply_filters('lastudio_wp_get_attachment_image_url', $item_image) );
