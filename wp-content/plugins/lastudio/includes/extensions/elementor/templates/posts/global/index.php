...
<div <?php echo $this->get_render_attribute_string( 'main-container' ); ?>><?php
    ...
    <?php
        ...
        if( $this->get_settings_for_display('paginate') == 'yes' ){
            ...
            ?>
            <nav class="<?php echo join(' ', $nav_classes) ?>" data-parent-container="#lapost_<?php echo $this->get_id() ?>" data-container="#lapost_<?php echo $this->get_id() ?> .lastudio-posts__list" data-item-selector=".loop__item" data-ajax_request_id="<?php echo $paged_key ?>">
