...
<div <?php $this->print_render_attribute_string( 'wrapper' ) ?>>
	...
	<?php
		if ( 'arrows-nav' === $settings['navigation_type'] ) {
			echo lastudio_elementor_tools_get_carousel_arrow( array( $settings['arrow_type'], 'lastudio-prev-arrow slick-prev lastudio-arrow-disabled' ) );
			echo lastudio_elementor_tools_get_carousel_arrow( array( $settings['arrow_type'], 'lastudio-next-arrow slick-next' ) );
		}
	?>
</div>