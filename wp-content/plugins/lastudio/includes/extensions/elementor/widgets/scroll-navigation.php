 ...
 */
class Scroll_Navigation extends LA_Widget_Base {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Scroll Navigation', 'lastudio' );
    }
    ...
    public function get_style_depends() {
        return [
            'lastudio-scroll-navigation-elm'
        ];
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'LaStudioElement/scroll-navigation/css-scheme',
            array(
        ...
        $repeater->add_control(
            'item_icon',
            array(
                'label'       => esc_html__( 'Hint Icon', 'lastudio' ),
        ...
        $repeater->add_control(
            'item_dot_icon',
            array(
                'label'       => esc_html__( 'Dot Icon', 'lastudio' ),
                'type'        => Controls_Manager::ICON,
                'label_block' => true,
                'file'        => '',
            )
        ...
        $repeater->add_control(
            'item_section_id',
            array(
                'label'   => esc_html__( 'Section Id', 'lastudio' ),
                'type'    => Controls_Manager::TEXT,
            )
        );
        ...
        $repeater->add_control(
            'item_section_invert',
            array(
                'label'        => esc_html__( 'Invert Under This Section', 'lastudio' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => array(
                    array(
                        'item_label'      => esc_html__( 'Section 1', 'lastudio' ),
                        'item_section_id' => 'section_1',
                    ),
                    array(
                        'item_label'      => esc_html__( 'Section 2', 'lastudio' ),
                        'item_section_id' => 'section_2',
                    ),
                    array(
                        'item_label'      => esc_html__( 'Section 3', 'lastudio' ),
        ...
        $this->add_control(
            'speed',
            array(
                'label'   => esc_html__( 'Scroll Speed', 'lastudio' ),
        ...
        $this->add_control(
            'offset',
            array(
                'label'   => esc_html__( 'Scroll Offset', 'lastudio' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 1,
            )
        );
        ...
        $this->add_control(
            'full_section_switch',
            array(
                'label'        => esc_html__( 'Full Section Switch', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio' ),
                'label_off'    => esc_html__( 'No', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_section(
            'section_hint_style',
            array(
                'label'      => esc_html__( 'Hint', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'hint_label_style',
            array(
                'label'     => esc_html__( 'Hint Label', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'hint_visible',
            array(
                'label'     => esc_html__( 'Hint Visible', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'desktop_hint_hide',
            array(
                'label'        => esc_html__( 'Hide On Desktop', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Hide', 'lastudio' ),
                'label_off'    => esc_html__( 'Show', 'lastudio' ),
                'return_value' => 'yes',
                'default'      => 'no',
            )
        );
        ...
        $this->add_control(
            'tablet_hint_hide',
            array(
                'label'        => esc_html__( 'Hide On Tablet', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Hide', 'lastudio' ),
                'label_off'    => esc_html__( 'Show', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'mobile_hint_hide',
            array(
                'label'        => esc_html__( 'Hide On Mobile', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Hide', 'lastudio' ),
                'label_off'    => esc_html__( 'Show', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->start_controls_tab(
            'tab_dots_invert',
            array(
                'label' => esc_html__( 'Invert', 'lastudio' ),
            )
        );
        ...
        $this->add_responsive_control(
            'dots_padding',
            array(
                'label'      => __( 'Dots Padding', 'lastudio' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
