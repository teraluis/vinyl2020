 ...
 */
class Subscribe_Form extends LA_Widget_Base {

    public function get_style_depends() {
        return [
            'lastudio-subscribe-form-elm'
        ];
    }
    ...
    protected function get_widget_title() {
        return esc_html__( 'Subscribe', 'lastudio' );
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
            'LaStudioElement/subscribe-form/css-scheme',
            array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Fields', 'lastudio' ),
            )
        );
        ...
        $this->add_control(
            'submit_button_text',
            array(
                'label'       => esc_html__( 'Submit Text', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Submit Button Text', 'lastudio' ),
                'default'     => esc_html__( 'Subscribe', 'lastudio' ),
            )
        );
        ...
        $this->add_control(
            'submit_placeholder',
            array(
                'label'       => esc_html__( 'Input Placeholder', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'E-Mail', 'lastudio' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Use Additional Fields', 'lastudio' ),
        ...
        $repeater->add_control(
            'type',
            [
                'label'   => esc_html__( 'Field Type', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'fname',
                'options' => [
                    'fname'   => esc_html__( 'First Name', 'lastudio' ),
                    'lname'   => esc_html__( 'Last Name', 'lastudio' ),
                    'address' => esc_html__( 'Address', 'lastudio' ),
                    'phone'   => esc_html__( 'Phone Number', 'lastudio' ),
                ]
            ]
        );
        ...
        $repeater->add_control(
            'placeholder',
            array(
                'label'   => esc_html__( 'Field Placeholder', 'lastudio' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'Enter Value', 'lastudio' ),
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'type'        => 'fname',
                        'placeholder' => esc_html__( 'First Name', 'lastudio' ),
                    ],
                    [
                        'type'        => 'lname',
                        'placeholder' => esc_html__( 'Last Name', 'lastudio' ),
                    ],
                    [
                        'type'        => 'address',
                        'placeholder' => esc_html__( 'Address', 'lastudio' ),
                    ],
                    [
                        'type'        => 'phone',
                        'placeholder' => esc_html__( 'Phone Number', 'lastudio' ),
                    ],
                ],
        ...
        $this->add_control(
            'use_redirect_url',
            array(
                'label'        => esc_html__( 'Use Redirect Url?', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio' ),
                'label_off'    => esc_html__( 'No', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'redirect_url',
            array(
                'label'       => esc_html__( 'Redirect Url', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Redirect Url', 'lastudio' ),
                'default'     => '#',
                'condition'   => array(
        ...
        $this->add_control(
            'use_target_list_id',
            array(
                'label'        => esc_html__( 'Use Target List Id?', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'lastudio' ),
                'label_off'    => esc_html__( 'No', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'target_list_id',
            array(
                'label'     => esc_html__( 'Mailchimp list id', 'lastudio' ),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'inline',
                'options' => array(
                    'inline' => esc_html__( 'Inline', 'lastudio' ),
        ...
        $this->start_controls_tab(
            'tab_container_error',
            array(
                'label' => esc_html__( 'Error', 'lastudio' ),
            )
        );
        ...
        $this->start_controls_section(
            'section_input_style',
            array(
                'label'      => esc_html__( 'Input', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            array(
                'label' => esc_html__( 'Focus', 'lastudio' ),
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Submit Button', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Message', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_tab(
            'tab_message_success',
            array(
                'label' => esc_html__( 'Success', 'lastudio' ),
            )
        );
