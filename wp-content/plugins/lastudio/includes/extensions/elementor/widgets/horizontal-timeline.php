 ...
 */
class Horizontal_Timeline extends LA_Widget_Base {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Horizontal Timeline', 'lastudio' );
    }
    ...
    public function get_style_depends() {
        return [
            'lastudio-horizontal-timeline-elm'
        ];
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'LaStudioElement/horizontal-timeline/css-scheme',
            array(
        ...
        $this->add_control(
            'show_card_arrows',
            array(
                'label'   => esc_html__( 'Show Card Arrows', 'lastudio' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'chess' => array(
                        'title' => esc_html__( 'Chess', 'lastudio' ),
        ...
        $this->add_control(
            'navigation_type',
            array(
                'label'   => esc_html__( 'Navigation Type', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'scroll-bar',
                'options' => array(
                    'scroll-bar' => esc_html__( 'Scroll Bar', 'lastudio' ),
                    'arrows-nav' => esc_html__( 'Arrows Navigation', 'lastudio' ),
                )
            )
        );
        ...
        $this->add_control(
            'arrow_type',
            array(
                'label'   => esc_html__( 'Arrow Type', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
        ...
        $this->add_responsive_control(
            'items_gap',
            array(
                'label' => esc_html__( 'Items Gap', 'lastudio' ),
        ...
        $this->start_controls_section(
            'section_image_style',
            array(
                'label' => esc_html__( 'Cards Content', 'lastudio' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_control(
            'image_stretch',
            array(
                'label'   => esc_html__( 'Stretch Image', 'lastudio' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
                'selectors'  => array(
        ...
        $this->add_control(
            'orders_heading',
            array(
                'label'     => esc_html__( 'Orders', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'image_order',
            array(
                'label' => esc_html__( 'Image Order', 'lastudio' ),
                'type'  => Controls_Manager::NUMBER,
                'min'   => 0,
                'max'   => 10,
                'selectors' => array(
...
//		);
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Scrollbar', 'lastudio' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'  => esc_html__( 'Currently works only in -webkit- browsers', 'lastudio' ),
        ...
        $this->add_control(
            'scrollbar_bg',
            array(
                'label'     => esc_html__( 'Scrollbar Color', 'lastudio' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            'scrollbar_thumb_bg',
            array(
                'label'     => esc_html__( 'Scrollbar Thumb Color', 'lastudio' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            'scrollbar_height',
            array(
                'label' => esc_html__( 'Scrollbar Height', 'lastudio' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 1,
        ...
        $this->add_control(
            'scrollbar_offset',
            array(
                'label' => esc_html__( 'Scrollbar Offset', 'lastudio' ),
                'type'  => Controls_Manager::SLIDER,
                'range' => array(
                    'px' => array(
                        'min' => 0,
    ...
    public function __render_image( $item_settings ) {
        ...
        $image_format = apply_filters( 'LaStudioElement/horizontal-timeline/image-format', '<div class="lastudio-hor-timeline-item__card-img">%s</div>' );
