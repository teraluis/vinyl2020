 ...
 * Table Widget
 */
class Table extends LA_Widget_Base {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Table', 'lastudio' );
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'LaStudioElement/table/css-scheme',
            array(
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Table Header', 'lastudio' ),
            )
        );
        ...
        $table_header_repeater->add_control(
            'add_icon_or_image',
            array(
                'label'   => esc_html__( 'Add icon/image', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
                'default' => '',
                'options' => array(
                    ''      => esc_html__( 'None', 'lastudio' ),
        ...
        $table_header_repeater->add_control(
            ...
            array(
                ...
                'default' => 'before',
                'options' => array(
                    'before' => esc_html__( 'Before', 'lastudio' ),
                    'after'  => esc_html__( 'After', 'lastudio' ),
                ),
                'condition' => array(
                    'add_icon_or_image!' => '',
                ),
        ...
        $table_header_repeater->start_controls_tab(
            'header_tab_advanced',
            array(
                'label' => esc_html__( 'Advanced', 'lastudio' ),
            )
        );
        ...
        $table_header_repeater->add_control(
            'col_span',
            array(
                'label' => esc_html__( 'Column Span', 'lastudio' ),
        ...
        $table_header_repeater->add_responsive_control(
            'col_width',
            array(
                'label' => esc_html__( 'Column Width', 'lastudio' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => array(
                    array(
                        'cell_text' => esc_html__( 'Heading #1', 'lastudio' ),
                    ),
                    array(
                        'cell_text' => esc_html__( 'Heading #2', 'lastudio' ),
                    ),
                    array(
                        'cell_text' => esc_html__( 'Heading #3', 'lastudio' ),
                    ),
                ),
                'title_field' => esc_html__( 'Column: ', 'lastudio' ) . '{{ cell_text }}',
            )
        );
        ...
        $this->start_controls_section(
            'section_table_body',
            array(
                'label' => esc_html__( 'Table Body', 'lastudio' ),
            )
        );
        ...
        $table_body_repeater->add_control(
            'action',
            array(
                'label'   => esc_html__( 'Action', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'cell',
                'options' => array(
                    'row'  => esc_html__( 'Start New Row', 'lastudio' ),
                    'cell' => esc_html__( 'Add New Cell', 'lastudio' ),
                ),
            )
        );
        ...
        $table_body_repeater->add_control(
            'row_custom_style',
            array(
                'label' => esc_html__( 'Add Custom Style', 'lastudio' ),
        ...
        $table_body_repeater->add_control(
            ...
            array(
                ...
                'placeholder' => esc_html__( 'https://your-link.com', 'lastudio' ),
                'condition' => array(
                    'action' => 'cell',
                ),
            )
        ...
        $table_body_repeater->add_control(
            'row_span',
            array(
                'label' => esc_html__( 'Row Span', 'lastudio' ),
                'type'  => Controls_Manager::NUMBER,
                'min'   => 1,
                'step'  => 1,
                'condition' => array(
        ...
        $table_body_repeater->add_control(
            'cell_is_th',
            array(
                'label' => esc_html__( 'This cell is Table Heading?', 'lastudio' ),
                'type'  => Controls_Manager::SWITCHER,
                'condition' => array(
                    'action' => 'cell',
                ),
        ...
        $table_body_repeater->add_control(
            'cell_is_th_desc',
            array(
                'raw'  => esc_html__( 'For this cell are applied table heading cell style', 'lastudio' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => array(
                    ...
                    array(
                        'action'    => 'cell',
                        'cell_text' => esc_html__( 'Simple content', 'lastudio' ),
                    ),
                    array(
                        'action'    => 'cell',
                        'cell_text' => esc_html__( 'Simple content', 'lastudio' ),
                ...
                'title_field' => '{{ action === "row" ? "' . esc_html__( 'Start Row:', 'lastudio' ) . '" : "' . esc_html__( 'Cell:', 'lastudio' ) . ' " + cell_text }}',
            )
        );
        ...
        $this->add_control(
            'sorting_table',
            array(
                'label'   => esc_html__( 'Sorting Table', 'lastudio' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            'responsive_table',
            array(
                'label'   => esc_html__( 'Responsive Table', 'lastudio' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => '',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'raw'  => esc_html__( 'Responsive table allow table to be scrolled horizontally.', 'lastudio' ),
                'type' => Controls_Manager::RAW_HTML,
                'content_classes' => 'elementor-descriptor',
                'condition'   => array(
        ...
        $this->add_control(
            'responsive_table_on',
            array(
                'label'       => esc_html__( 'Responsive On', 'lastudio' ),
                'label_block' => true,
                'type'        => Controls_Manager::SELECT2,
                'multiple'    => true,
                'default'     => array( 'mobile' ),
                'options'     => array(
                    'mobile'  => esc_html__( 'Mobile', 'lastudio' ),
                    'tablet'  => esc_html__( 'Tablet', 'lastudio' ),
                    'desktop' => esc_html__( 'Desktop', 'lastudio' ),
                ),
                'condition'   => array(
                    'responsive_table' => 'yes',
                ),
        ...
        $this->add_responsive_control(
            'table_width',
            array(
                'label' => esc_html__( 'Table Width', 'lastudio' ),
                'type'  => Controls_Manager::SLIDER,
                'size_units' => array( '%', 'px' ),
                'range' => array(
                    'px' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'fixed' => esc_html__( 'Fixed (Equal width)', 'lastudio' ),
                ),
                'default' => 'auto',
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'table_align',
            array(
                'label' => esc_html__( 'Table Alignment', 'lastudio' ),
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Hidden border for header container', 'lastudio' ),
                'type'  => Controls_Manager::SWITCHER,
                'selectors'  => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => '<b>' . esc_html__( 'Icon', 'lastudio' ) . '</b>',
        ...
        $this->add_control(
            ...
            array(
                'label' => '<b>' . esc_html__( 'Image', 'lastudio' ) . '</b>',
                'type'  => Controls_Manager::POPOVER_TOGGLE,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'sorting_icon_style',
            array(
                'label' => '<b>' . esc_html__( 'Sorting Icon', 'lastudio' ) . '</b>',
                'type'  => Controls_Manager::POPOVER_TOGGLE,
                'separator' => 'before',
                'condition' => array(
                    'sorting_table' => 'yes',
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Background Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Striped rows', 'lastudio' ),
                'type'  => Controls_Manager::SWITCHER,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Background Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Link Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Hover Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Row Hover Background Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Hover Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Even Row Hover Background Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Cell Hover Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Cell Hover Background Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Link Hover Color', 'lastudio' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label' => esc_html__( 'Hidden border for body container', 'lastudio' ),
                'type'  => Controls_Manager::SWITCHER,
                'selectors'  => array(
