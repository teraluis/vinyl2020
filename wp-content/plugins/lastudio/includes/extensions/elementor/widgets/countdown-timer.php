 ...
 */
class Countdown_Timer extends LA_Widget_Base {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Countdown Timer', 'lastudio' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'due_date',
            array(
                'label'       => esc_html__( 'Due Date', 'lastudio' ),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => $default_date,
                'description' => sprintf(
                    esc_html__( 'Date set according to your timezone: %s.', 'lastudio' ),
        ...
        $this->add_control(
            'show_days',
            array(
                'label'        => esc_html__( 'Days', 'lastudio' ),
        ...
        $this->add_control(
            'label_days',
            array(
                'label'       => esc_html__( 'Days Label', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Days', 'lastudio' ),
                'placeholder' => esc_html__( 'Days', 'lastudio' ),
                'condition'   => array(
                    'show_days'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_hours',
            array(
                'label'        => esc_html__( 'Hours', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'lastudio' ),
                'label_off'    => esc_html__( 'Hide', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_hours',
            array(
                'label'       => esc_html__( 'Hours Label', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Hours', 'lastudio' ),
                'placeholder' => esc_html__( 'Hours', 'lastudio' ),
                'condition'   => array(
                    'show_hours'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_min',
            array(
                'label'        => esc_html__( 'Minutes', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'lastudio' ),
                'label_off'    => esc_html__( 'Hide', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_min',
            array(
                'label'       => esc_html__( 'Minutes Label', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Minutes', 'lastudio' ),
                'placeholder' => esc_html__( 'Minutes', 'lastudio' ),
                'condition'   => array(
                    'show_min'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'show_sec',
            array(
                'label'        => esc_html__( 'Seconds', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'lastudio' ),
                'label_off'    => esc_html__( 'Hide', 'lastudio' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'label_sec',
            array(
                'label'       => esc_html__( 'Seconds Label', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Seconds', 'lastudio' ),
                'placeholder' => esc_html__( 'Seconds', 'lastudio' ),
                'condition'   => array(
                    'show_sec'      => 'yes',
                ),
            )
        ...
        $this->add_control(
            'blocks_sep',
            array(
                'label'       => esc_html__( 'Blocks Separator', 'lastudio' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => ':',
            )
        ...
        $css_scheme = apply_filters(
            'LaStudioElement/lastudio-countdown-timer/css-scheme',
            array(
        ...
        $this->add_control(
            'items_size',
            array(
                'label'   => esc_html__( 'Items Size', 'lastudio' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Labels', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Digits', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'digit_item_heading',
            array(
                'label'     => esc_html__( 'Digit Item Styles', 'lastudio' ),
        ...
        $this->start_controls_section(
            'section_sep_styles',
            array(
                'label'      => esc_html__( 'Separator Styles', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'sep_font',
            array(
                'label'     => esc_html__( 'Font', 'lastudio' ),
        ...
        $this->add_control(
            'value_order',
            array(
                'label'   => esc_html__( 'Digit Order', 'lastudio' ),
        ...
        $this->add_control(
            'label_order',
            array(
                'label'   => esc_html__( 'Label Order', 'lastudio' ),
                'type'    => Controls_Manager::NUMBER,
                'default' => 2,
                'min'     => 1,
                'max'     => 2,
    ...
    public function blocks_separator() {
        ...
        $format = apply_filters(
            'LaStudioElement/lastudio-countdown-timer/blocks-separator-format',
