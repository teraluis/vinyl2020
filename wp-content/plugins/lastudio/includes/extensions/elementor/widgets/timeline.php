 ...
 * Timeline Widget
 */
class Timeline extends LA_Widget_Base {
    ...
    protected function get_widget_title() {
        return esc_html__( 'Vertical Timeline', 'lastudio' );
    }

    public function get_icon() {
        return 'lastudioelements-icon-38';
    }

    public function get_style_depends() {
        return [
            'lastudio-timeline-elm'
        ];
    }
    ...
    protected function _register_controls() {
        $css_scheme = apply_filters(
            'LaStudioElement/timeline/css-scheme',
            array(
                'line'               => '.lastudio-timeline__line',
                'progress'           => '.lastudio-timeline__line-progress',
                'item'               => '.lastudio-timeline-item',
        ...
        $this->start_controls_section(
            'section_cards',
            array(
                'label' => esc_html__( 'Cards', 'lastudio' ),
            )
        );
        ...
        $repeater->add_control(
            'show_item_image',
            array(
                'label'        => esc_html__( 'Show Image', 'lastudio' ),
        ...
        $repeater->add_control(
            'item_point',
            array(
                'label'     => esc_html__( 'Point', 'lastudio' ),
        ...
        $repeater->add_control(
            'item_point_type',
            array(
                'label'   => esc_html__( 'Point Content Type', 'lastudio' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'icon',
                'options' => array(
                    'icon' => esc_html__( 'Icon', 'lastudio' ),
                    'text' => esc_html__( 'Text', 'lastudio' ),
                ),
            )
        );
        ...
        $repeater->add_control(
            'item_point_icon',
            array(
                'label'       => esc_html__( 'Point Icon', 'lastudio' ),
        ...
        $repeater->add_control(
            'item_point_text',
            array(
                'label'     => esc_html__( 'Point Text', 'lastudio' ),
                'type'      => Controls_Manager::TEXT,
                'default'   => 'A',
                'condition' => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => array(
                    array(
                        'item_title'      => esc_html__( 'Card #1', 'lastudio' ),
                        ...
                        'item_meta'       => esc_html__( 'Thursday, August 31, 2018', 'lastudio' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #2', 'lastudio' ),
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'lastudio' ),
                        'item_meta'       => esc_html__( 'Thursday, August 29, 2018', 'lastudio' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #3', 'lastudio' ),
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'lastudio' ),
                        'item_meta'       => esc_html__( 'Thursday, August 28, 2018', 'lastudio' ),
                    ),
                    array(
                        'item_title'      => esc_html__( 'Card #4', 'lastudio' ),
                        'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'lastudio' ),
                        'item_meta'       => esc_html__( 'Thursday, August 27, 2018', 'lastudio' ),
                    ),
                ),
        ...
        $this->add_control(
            'animate_cards',
            array(
                'label'        => esc_html__( 'Animate Cards', 'lastudio' ),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'lastudio-timeline-item--animated',
                'default'      => '',
            )
        );
        ...
        $this->add_responsive_control(
            'horizontal_space',
            array(
                'label'      => esc_html__( 'Horizontal Space', 'lastudio' ),
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item_point'] => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .lastudio-timeline--align-left ' . $css_scheme['item_point']   => 'margin-right: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .lastudio-timeline--align-right ' . $css_scheme['item_point']  => 'margin-left: {{SIZE}}{{UNIT}}',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            'vertical_space',
            array(
                'label'      => esc_html__( 'Vertical Space', 'lastudio' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
        ...
        $this->start_controls_section(
            'section_line_style',
            array(
                'label'      => esc_html__( 'Line', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
    ...
    public function _control_section_cards( $css_scheme ) {
        ...
        $this->add_control(
            'cards_arrow_heading',
            array(
                'label'     => esc_html__( 'Arrow', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'selectors'  => array(
                    ...
                    '{{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop){{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop){{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop) .rtl {{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(odd) ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '(desktop) .rtl {{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['item'] . ':nth-child(even) ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .lastudio-timeline--align-left ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-left:calc( -{{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .lastudio-timeline--align-right ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-right:calc( -{{SIZE}}{{UNIT}} / 2 );',
                ),
            )
        );
    ...
    public function _control_section_image( $css_scheme ) {
        ...
        $this->add_responsive_control(
            'image_spacing',
            array(
                'label'      => esc_html__( 'Spacing', 'lastudio' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
    ...
    public function _control_section_card_content( $css_scheme ) {
        ...
        $this->add_control(
            'card_arrow_heading',
            array(
                'label'     => esc_html__( 'Card Arrow', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => array(
        ...
        $this->add_responsive_control(
            'card_arrow_offset',
            array(
                'label'      => esc_html__( 'Card Arrow Offset', 'lastudio' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                    '%',
                ...
                'selectors'  => array(
                    '{{WRAPPER}} .lastudio-timeline--align-top ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow']    => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .lastudio-timeline--align-bottom ' . $css_scheme['item'] . ' ' . $css_scheme['card_arrow'] => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ),
                'condition'  => array(
                    'vertical_alignment!' => 'middle'
                )
    ...
    public function _control_section_points( $css_scheme ) {
        ...
        $this->add_responsive_control(
            'point_size',
            array(
                'label'      => esc_html__( 'Point Size', 'lastudio' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
                ...
                'selectors'  => array(
                    ...
                    '{{WRAPPER}} .lastudio-timeline--align-center ' . $css_scheme['line'] => 'margin-left: calc( {{SIZE}}{{UNIT}} / 2 ); margin-right: calc( {{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .lastudio-timeline--align-left ' . $css_scheme['line']   => 'margin-left: calc( {{SIZE}}{{UNIT}} / 2 );',
                    '{{WRAPPER}} .lastudio-timeline--align-right ' . $css_scheme['line']   => 'margin-right: calc( {{SIZE}}{{UNIT}} / 2 );',
                ),
            )
        );
    ...
    public function _control_section_line( $css_scheme ) {
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Line Color', 'lastudio' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Progress Color', 'lastudio' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->add_responsive_control(
            'line_width',
            array(
                'label'      => esc_html__( 'Thickness', 'lastudio' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => array(
                    'px',
                ),
