 ...
 */
class Contact_Form_7 extends LA_Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Contact Form 7', 'lastudio' );
    }

    public function get_icon() {
        return 'lastudioelements-icon-13';
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_settings',
            array(
                'label' => esc_html__( 'Form', 'lastudio' ),
            )
        );
        ...
        $this->add_control( 'form_shortcode', array(
            'label'   => esc_html__( 'Select Form', 'lastudio' ),
        ...
        $this->start_controls_section(
            'section_text_style',
            array(
                'label'      => esc_html__( 'Form Texts', 'lastudio' ),
        ...
        $this->add_control(
            'invalid_heading',
            array(
                'label'     => esc_html__( 'Not Valid Notices', 'lastudio' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Controls', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Placeholder Color', 'lastudio' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
        ...
        $this->start_controls_tab(
            'tab_input_invalid',
            array(
                'label' => esc_html__( 'Not Valid', 'lastudio' ),
            )
        );
        ...
        $this->add_responsive_control(
            'select_min_height',
            array(
                'label'       => esc_html__( 'Select Minimal Height', 'lastudio' ),
                'label_block' => true,
        ...
        $this->add_responsive_control(
            'textarea_min_height',
            array(
                'label'       => esc_html__( 'Textarea Minimal Height', 'lastudio' ),
                'label_block' => true,
                'type'        => Controls_Manager::NUMBER,
                'default'     => '',
                'selectors'   => array(
        ...
        $this->add_control(
            'arrows',
            array(
                'label'        => esc_html__( 'Fullwidth Button', 'lastudio' ),
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Alerts', 'lastudio' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            'sent_heading',
            array(
                'label'     => esc_html__( 'Sent Success', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'error_heading',
            array(
                'label'     => esc_html__( 'Sent Error', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
        ...
        $this->add_control(
            'spam_heading',
            array(
                'label'     => esc_html__( 'Spam Blocked', 'lastudio' ),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            )
        );
