(function($) {
	...
	var wc_simple_path_form = {
		...
		init: function() {
			...
			wc_simple_path_form.json_key_input.on( 'change paste keyup', this.json_key_on_change );
		...
		json_key_on_change: function() {
			try {
				...
				// Setting Values
				//Seller Id
				$( '#woocommerce_amazon_payments_advanced_seller_id' ).val( json_value.merchant_id );
				//MWS Access Key
				$( '#woocommerce_amazon_payments_advanced_mws_access_key' ).val( json_value.access_key );
				//MWS Secret Key
				$( '#woocommerce_amazon_payments_advanced_secret_key' ).val( json_value.secret_key );
				// App Client Id
				$( '#woocommerce_amazon_payments_advanced_app_client_id' ).val( json_value.client_id );
				// App Client Secret
				$( '#woocommerce_amazon_payments_advanced_app_client_secret' ).val( json_value.client_secret );
			} catch (err) {
