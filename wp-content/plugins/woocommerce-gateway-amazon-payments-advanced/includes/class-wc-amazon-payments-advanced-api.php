...
class WC_Amazon_Payments_Advanced_API {
	...
	public static $get_public_keys_urls = array(
		...
		'gb' => 'https://payments-europe.amazon.com/register/getsigpublickey',
		'eu' => 'https://payments-europe.amazon.com/register/getsigpublickey',
	...
	public static function is_sca_region() {
		return ( 'eu' === self::get_region() || 'gb' === self::get_region() );
	}
	...
	public static function format_address( $address ) {
		...
		// @codingStandardsIgnoreStart
		$address_name            = explode( ' ', ! empty( $address->Name ) ? (string) $address->Name : '' );
